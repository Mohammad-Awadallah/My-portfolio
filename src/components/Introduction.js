...
const Introduction = ()=>{
    ...
    return <section className="intro" id="introSection">
        <div className='content'>
            <h2>Hello, I'm Mohammad  </h2>
            <h3>FrontEnd Developer</h3>
            <h4>I build The UserInterface of Web Applications</h4>
            <a href="#projectSection" className='abtn' >View my Projects</a>
            <div className="icons">
